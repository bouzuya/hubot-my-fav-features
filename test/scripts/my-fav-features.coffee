...
describe 'hello', ->
  ...
  describe 'listeners[0].regex', ->
    describe 'valid patterns', ->
      beforeEach ->
        @tests = [
          message: '@hubot my-fav-features'
          matches: ['@hubot my-fav-features']
        ,
          message: '@hubot myfav features'
          matches: ['@hubot myfav features']
        ]
  ...
  describe 'robot.helpCommands()', ->
    it 'should be ["hubot my-fav-features - my-fav features"]', ->
